...
Tandem events like these are good for occlusions: the actor behind is largely covered by the actor before it. Make detectors work on this lol. Make it hallucinate the mask of the object which it cannot see. Make it dream as well as do perception. Make it work as a little boltzmann machine. This cute little guy has been released [here](https://www.crcv.ucf.edu/data1/rajat_occ_action_detection/mso-real_oucf.sq).
