...
**The post-alexnet scientist**: Well ok, so what? How do we solve it? Well, read the slow science manifesto [here](http://slow-science.org/). Some notable people (trying) to support it are [1](https://people.eecs.berkeley.edu/~efros/),[2](https://vilab.epfl.ch/zamir/).
## Dataset Release.
