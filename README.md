...
Olympics. Millions glued their eyes on their TV. The place where the best of humans compete. Audience thought they were competing. But, the actors were in synchrony: they were collaborating. Minds became one, and bodies flowed together. The vectors of neurons in their brains were rotating synchronously: they converged onto same phase and magnitude. They saw only one object: the pool in front of them. There is no complexity, its simple: their destinies were binding together. Islands are potatoes whose rotation takes a lot of time to track. [GLOM]
