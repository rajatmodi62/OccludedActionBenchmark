...
Olympics. Millions glu(on)ed their eyes to their digital screens. The place where the best of (humans) compete. Audience thought they were competing. But, the actors were in synchrony: they were collaborating. Their minds became one and the bodies flowed together. The vectors of neurons in their brains rotated synchronously: they converged onto same phase and magnitude. The players routed their attention to only one object: the swimming pool in front of them. The environment was (enigma)tic: everyone stopped their breath. There is no complexity, its simple: their destinies were binding and intertwined together. These actors are potatoes whose rotation takes a lot of effort (and time) to track. [GLOM]
