...
- `2024.04`:  We wish GLOM could be made to work. Surely you are joking, Mr. Feynman. Stay tuned (lol).....
...
Olympics. Millions glued their eyes to their digital screens. The place where the best of (humans) compete. Audience thought they were competing. But, the actors were in synchrony: they were collaborating. Their minds became one and the bodies flowed together. The vectors of neurons in their brains were rotating synchronously: they converged onto same phase and magnitude. They saw only one object: the swimming pool in front of them. There is no complexity, its simple: their destinies were binding and intertwined together. These actors are potatoes whose rotation takes a lot of time to track. [GLOM]

Tandem events like these are good for occlusions: the actor behind is largely covered by the actor before it. Make detectors work on this lol. Make it hallucinate the mask of the object which it cannot ever see. Make it dream as well as do perception. Make it work as a  boltzmann machine. This cute little guy has been released [here](https://www.crcv.ucf.edu/data1/rajat_occ_action_detection/mso-real_oucf.sq).
