...
Olympics. Millions were glued to their TV. The place where the best of humans compete. Audience thought they were competing. But, the actors were in synchrony: they were collaborating. Minds became one, and bodies flowed together. The vectors of neurons in their brains were rotating synchronously: they converged on same phase and magnitude. There is no complexity, its simple: they were binding together. Islands are potatoes whose rotation takes a lot of time to track.

Tandem events are good for occlusions: the actor behind is largely covered by the actor before it. Make detectors work on this lol. 
